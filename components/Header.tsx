  ...
  return (
    <header className="p-5 flex justify-between  sticky top-0 bg-white z-50 shadow-md">
      <div className="flex space-x-2 items-center">
        ...
        <div>
          <h1 className="font-bold">
            DALL-E <span className="text-violet-500">AI</span> Image Generator
          </h1>
      ...
      <div className="flex divide-x text-gray-500 items-center text-xs md:text-base">
        <Link
          href="https://portfolio-2-0-itsmohammednayeem.vercel.app/"
          className="px-2 font-light text-right"
        >
          Portfolio
        </Link>
        <Link
          href="https://github.com/itsMohammedNayeem/"
